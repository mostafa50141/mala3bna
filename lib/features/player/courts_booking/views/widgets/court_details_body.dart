            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: CustomCarouselSlider(
                    images: widget.court.images, imageUrl: widget.court.imageUrl),
                expandedHeight: 220,
                        ...
                        children: [
                          if (widget.court.hasLights)
                            const Padding(
                              ...
                              child: AmenitiesItem(
                                  icon: Icons.lightbulb_outline, label: 'Lights'),
                            ),
                          ...
                          if (widget.court.hasEquipment)
                            const Padding(
                              padding: EdgeInsets.only(right: 20),
                              child: AmenitiesItem(
                                  icon: Icons.sports, label: 'Equipment'),
                            ),
                        ],
                      ),
                    ),
                                ...
                                onTap: () {
                                  ...
                                  showModalBottomSheet(
                                    ...
                                    builder: (sheetContext) => BlocProvider.value(
                                      value: reviewCubit,
                                      child: AddReviewBottomSheet(fieldId: widget.court.id),
                                    ),
                                  );
                                },
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      const Icon(Icons.add, color: AppColors.primaryColor, size: 14),
                                      const Gap(4),
                                      Text(
                                        'Add Review',
