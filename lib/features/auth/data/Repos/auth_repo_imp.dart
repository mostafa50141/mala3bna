...
class AuthRepoImp implements AuthRepo {
  ...
  Future<Either<Failure, Usermodel>> login({
    ...
    try {
      ...
      if (access != null) {
        print(
          'DEBUG: Saving JWT tokens — access=${access.substring(0, 20)}...',
        );
        ...
        print(
          'DEBUG: Saving single token — ${user.token!.substring(0, 20)}...',
        );
      ...
      print(
        'DEBUG: Token saved successfully — ${savedToken != null ? 'YES (${savedToken.substring(0, 20)}...)' : 'NO — null!'}',
      );
